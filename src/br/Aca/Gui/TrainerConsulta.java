...
class TrainerConsulta extends JFrame {
	...
	TrainerConsulta(JFrame framePai, Conexao conexao){ // m�todo construtor
		super("Consulta de Trainer"); // chamando construtor da classe m�e
		setSize(800, 400);				// definindo dimens�es da janela
		...
		cmbChaves = new JComboBox(new String[] {"C�digo", "Nome"});
