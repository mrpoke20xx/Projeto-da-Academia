...
import br.Aca.Logic.AcademiaLogic;
...
public class CadastroCliente  {
	...
	public CadastroCliente() {
		...
		p_Operacoes.add(lb1);p_Operacoes.add(tf_tra_cod);
		p_Operacoes.add(lb2);p_Operacoes.add(tf_cod);
		p_Operacoes.add(lb3);p_Operacoes.add(tf_sexo);
		p_Operacoes.add(lb4);p_Operacoes.add(tf_nome);
		p_Operacoes.add(lb5);p_Operacoes.add(tf_endereco);
		p_Operacoes.add(lb6);p_Operacoes.add(tf_nasc);
		p_Operacoes.add(lb7);p_Operacoes.add(tf_necessidade);
	...
	class AcaoConfirmar extends AbstractAction{
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {			
				...
				switch (acao) {
				case INCLUSAO:
					pl.addAluno(tra_cod, cli_cod, sexo, nome, 
							endereco, nasc, necessidade);
					break;
				case EDICAO:
					pl.updAluno(tra_cod, cli_cod, sexo, nome, 
							endereco, nasc, necessidade);
					break;
				case EXCLUSAO:
					pl.delAluno(tra_cod, cli_cod, sexo, nome, 
							endereco, nasc, necessidade);				
					break;
				}
				limparCampos();
